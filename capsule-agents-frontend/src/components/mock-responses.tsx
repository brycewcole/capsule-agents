...
export default function MockResponses() {
  const [mockResponses, setMockResponses] = useState<MockResponse[]>([
    ...
    },
    {
      ...
      pattern: "What is",
      response:
        "I'm not sure about that specific question, but I'd be happy to help you find the answer.",
    },
  ])
  ...
  return (
    <Card className="shadow-md">
      <CardHeader>
        ...
        <CardDescription>
          Create predefined responses for specific user inputs
        </CardDescription>
      </CardHeader>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value: MatchType) =>
                setNewMock({ ...newMock, matchType: value })}
            >
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                disabled={!newMock.pattern || !newMock.response}
              >
                  ...
                  <TableRow key={mock.id}>
                    <TableCell>
                      <Badge variant="outline">
                        {getMatchTypeLabel(mock.matchType)}
                      </Badge>
                    </TableCell>
      ...
      <CardFooter className="flex justify-end border-t p-4">
        <Button
          onClick={saveMockResponses}
          disabled={mockResponses.length === 0}
        >
